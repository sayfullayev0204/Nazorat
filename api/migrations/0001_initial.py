# Generated by Django 5.0 on 2025-01-03 03:35
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('room_situation', models.BooleanField(default=False)),
                ('heating_system', models.BooleanField(default=False)),
                ('kitchen_system', models.BooleanField(default=False)),
                ('description', models.TextField()),
                ('imge_1', models.ImageField(blank=True, null=True, upload_to='stiuation')),
                ('imge_2', models.ImageField(blank=True, null=True, upload_to='stiuation')),
                ('imge_3', models.ImageField(blank=True, null=True, upload_to='stiuation')),
                ('appartment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.appartment')),
            ],
        ),
        migrations.CreateModel(
            name='Students',
